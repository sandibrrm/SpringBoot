...
#[derive(Debug)]
pub struct SpringBootProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpringBootProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpringBoot processing");
    
    let mut processor = SpringBootProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpringBootProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpringBootProcessor::new(false);
